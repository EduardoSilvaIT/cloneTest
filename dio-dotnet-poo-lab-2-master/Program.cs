...
// ===========================================================================================================
        ...
        private static void ListarFilmes()
		{
			...
			foreach (var Filme in lista)
			{
				...
				Console.WriteLine("#ID {0}: - {1} {2} {3} ", Filme.retornaId(), Filme.retornaTitulo(), Filme.retornaAno(), (excluido ? "*Excluído*" : ""));
			}
		}
        ...
        private static void InserirFilme()
		{
			...
			Filme novaFilme = new Filme(id: frepositorio.ProximoId(),
										genero: (Genero)entradaGenero,
										titulo: entradaTitulo,
										ano: entradaAno,
										descricao: entradaDescricao);

			frepositorio.Insere(novaFilme);
		}
